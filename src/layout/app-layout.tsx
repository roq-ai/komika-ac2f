...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'editor', 'social-media-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Bookmark', path: '/bookmarks', entity: 'bookmark', service: AccessServiceEnum.PROJECT, icon: FiBookmark },
    { name: 'Favorite', path: '/favorites', entity: 'favorite', service: AccessServiceEnum.PROJECT, icon: FiHeart },
    { name: 'Manga', path: '/manga', entity: 'manga', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
